"""
Neikos: Hundred Islands — LEGACY FILE (preserved for reference)

This file is the original monolith. It has been superseded by the
plugins/neikos/ package. Do NOT load this as an active plugin.
"""
# Prevent bookmark.py from loading this as an active plugin.
IS_FEED = False


def register_widgets(registry, runtime_stub):
    """Stub — real implementation is in plugins/neikos/__init__.py"""
    pass


# ---- original source below (reference only) ----
